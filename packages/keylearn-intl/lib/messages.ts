...
export async function loadMessages(locale: LocaleId): Promise<Messages> {
  switch (locale) {
    ...
    case "as":
      return (
        await import(
          /* webpackChunkName: "messages-as" */ "./messages/as.json",
          { with: { type: "json" } }
        )
      ).default;
    ...
    case "mr":
      return (
        await import(
          /* webpackChunkName: "messages-mr" */ "./messages/mr.json",
          { with: { type: "json" } }
        )
      ).default;
    ...
    case "or":
      return (
        await import(
          /* webpackChunkName: "messages-or" */ "./messages/or.json",
          { with: { type: "json" } }
        )
      ).default;
    ...
    case "pa":
      return (
        await import(
          /* webpackChunkName: "messages-pa" */ "./messages/pa.json",
          { with: { type: "json" } }
        )
      ).default;
