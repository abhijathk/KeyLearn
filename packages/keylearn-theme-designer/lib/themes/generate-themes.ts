...
import { Color, parseColor } from "@keylearn/color";
import { rootDir } from "@keylearn/scripts/root.js";
import { CustomTheme, themeProps, themePropsMap } from "@keylearn/themes";
...
function formatSourceCode(themes: Map<string, CustomTheme>): string {
  ...
  lines.push(``);
  lines.push(`import { parseColor } from "@keylearn/color";`);
  lines.push(`import { CustomTheme } from "@keylearn/themes";`);
