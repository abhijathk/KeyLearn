import { Enum, XEnum, type XEnumItem } from "@keylearn/lang";
...
export class Layout implements XEnumItem {
  ...
  static readonly TA_INSCRIPT = new Layout(
    /* id= */ "ta-inscript",
    /* xid= */ 0xc0,
    /* name= */ "Tamil InScript",
    /* family= */ "ta-inscript",
  ...
  static readonly TE_INSCRIPT = new Layout(
    /* id= */ "te-inscript",
    /* xid= */ 0xc1,
  ...
  static readonly TE_PHONETIC = new Layout(
    /* id= */ "te-phonetic",
    /* xid= */ 0xc2,
  ...
  static readonly KN_INSCRIPT = new Layout(
    /* id= */ "kn-inscript",
    /* xid= */ 0xc3,
  ...
  static readonly KN_PHONETIC = new Layout(
    /* id= */ "kn-phonetic",
    /* xid= */ 0xc4,
  ...
  static readonly GU_INSCRIPT = new Layout(
    /* id= */ "gu-inscript",
    /* xid= */ 0xc5,
  ...
  static readonly GU_PHONETIC = new Layout(
    /* id= */ "gu-phonetic",
    /* xid= */ 0xc6,
  ...
  static readonly BN_INSCRIPT = new Layout(
    /* id= */ "bn-inscript",
    /* xid= */ 0xc7,
  ...
  static readonly BN_PHONETIC = new Layout(
    /* id= */ "bn-phonetic",
    /* xid= */ 0xc8,
  ...
  static readonly UR_INSCRIPT = new Layout(
    /* id= */ "ur-inscript",
    /* xid= */ 0xc9,
    /* name= */ "Urdu InScript",
    /* family= */ "ur-inscript",
  ...
  static readonly UR_PHONETIC = new Layout(
    /* id= */ "ur-phonetic",
    /* xid= */ 0xca,
    /* name= */ "Urdu Phonetic",
    /* family= */ "ur-phonetic",
