...
test("get file name for user id", () => {
  const dataDir = new DataDir("/keylearn");

  equal(
    dataDir.userSettingsFile(1),
    "/keylearn/user_settings/000/000/000000001",
  );
  equal(
    dataDir.userSettingsFile(123_456_789),
    "/keylearn/user_settings/123/456/123456789",
  );
  equal(dataDir.userStatsFile(1), "/keylearn/user_stats/000/000/000000001");
  equal(
